...
app.config['UPLOAD_FOLDER'] = 'D:/GlowGetaway/src/frontend/images/Hotel'  # Directory where images are stored
...
def create_itinerary_pdf(itinerary, source, destination, days):
    ...
    pdf.image('D:/GlowGetaway/public/images/background.jpg', x=0, y=0, w=pdf.w, h=pdf.h)
